      ...
      <div>
        ...
        <section className="p-0 layout-7">
          <Slider className="slide-1 home-slider">
            <div>
              <div className="home">
                <img src="/assets/images/marketplace/home-slider/7.jpg" alt="" className="bg-img blur-up lazyload" />
            ...
            <div>
              <div className="home">
                <img src="/assets/images/marketplace/home-slider/5.jpg" alt="" className="bg-img blur-up lazyload" />
                <div className="container">
                  <div className="row">
                    <div className="col">
                      <div className="slider-contain">
            ...
            <div>
              <div className="home">
                <img src="/assets/images/marketplace/home-slider/6.jpg" alt="" className="bg-img blur-up lazyload" />
                <div className="container">
                  <div className="row">
                    <div className="col">
                      <div className="slider-contain">
          ...
          <div className="container absolute-bg">
            <div className="service p-0 ">
              <div className="row">
                ...
                <div className="col-lg-3 col-sm-6 service-block">
                  <div className="media">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 480 480" style={{ enableBackground: 'new 0 0 480 480' }} xmlSpace="preserve" width="512px" height="512px">
                      <g>
                        <g>
                          <g>
                ...
                <div className="col-lg-3 col-sm-6 service-block">
                  <div className="media">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 512 512" style={{ enableBackground: 'new 0 0 512 512' }} xmlSpace="preserve" width="512px" height="512px">
                      <g>
                        <g>
                          <g>
            ...
            <div className="row">
              <div className="col-12">
                <div className="title-basic">
                  <h2 className="title font-fraunces"><i className="ti-bolt" /> deals of the day</h2>
                  <div className="timer">
                    <p id="demo" />
                  </div>
                </div>
              ...
              <div className="col">
                <Slider slidesToShow={5} slidesToScroll={2} className="slide-6-product product-m no-arrow">
                  <div className="product-box product-wrap">
                    ...
                    <div className="product-detail">
                      <div className="rating"><i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" />
                      </div>
                  ...
                  <div className="product-box product-wrap">
                    <div className="img-wrapper">
                      <div className="front">
                        <a href="product-page(no-sidebar).html"><img src="/assets/images/marketplace/pro/22.jpg" className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                      </div>
                      <div className="back">
                  ...
                  <div className="product-box product-wrap">
                    <div className="img-wrapper">
                      <div className="front">
                        <a href="product-page(no-sidebar).html"><img src="/assets/images/marketplace/pro/27.jpg" className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                      </div>
                      <div className="back">
                  ...
                  <div className="product-box product-wrap">
                    <div className="img-wrapper">
                      <div className="front">
                        <a href="product-page(no-sidebar).html"><img src="/assets/images/marketplace/pro/23.jpg" className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                      </div>
                      <div className="back">
                  ...
                  <div className="product-box product-wrap">
                    ...
                    <div className="product-detail">
                      ...
                      <h4>$500.00</h4>
                      <ul className="color-variant quantity-variant box-l">
                        <li className="bg-light">32</li>
                        <li className="bg-light">34</li>
                        <li className="bg-light">36</li>
                      </ul>
                      <div className="progress-section">
                        <div className="progress">
                          <div className="progress-bar" role="progressbar" style={{ width: '75%' }} aria-valuenow={75} aria-valuemin={0} aria-valuemax={100} />
        ...
        <section className="pt-0 ratio_square section-b-space">
          <div className="container">
            <div className="row">
              <div className="col-lg-3 col-md-4 col-sm-6 col-6">
                <div className="h-100">
                  <img src="/assets/images/marketplace/banner/vertical2.jpg" className="img-fluid bg-img bg-top" alt="" />
                </div>
              </div>
              <div className="col-lg-9 col-md-8 col-sm-6 col-6">
                <Slider slidesToShow={5} slidesToScroll={2} className="marketplace-5 product-m no-arrow">
                  <div className="product-box product-wrap">
                    <div className="img-wrapper">
                      <div className="front">
                        <a href="product-page(no-sidebar).html"><img src="/assets/images/marketplace/pro/30.jpg" className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                      </div>
                      <div className="back">
                  ...
                  <div className="product-box product-wrap">
                    <div className="img-wrapper">
                      <div className="front">
                        <a href="product-page(no-sidebar).html"><img src="/assets/images/marketplace/pro/33.jpg" className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                      </div>
                      <div className="back">
                    ...
                    <div className="product-detail">
                      ...
                      <h4>$500.00</h4>
                      <ul className="color-variant quantity-variant box-l">
                        <li className="bg-light">1L</li>
                        <li className="bg-light">2L</li>
                      </ul>
                    </div>
                  </div>
                  <div className="product-box product-wrap">
                    <div className="img-wrapper">
                      <div className="front">
                        <a href="product-page(no-sidebar).html"><img src="/assets/images/marketplace/pro/16.jpg" className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                      </div>
                      <div className="back">
                    ...
                    <div className="product-detail">
                      ...
                      <ul className="color-variant quantity-variant box-l">
                        <li className="bg-light">S</li>
                        <li className="bg-light">M</li>
                        <li className="bg-light">L</li>
                        <li className="bg-light">XXL</li>
                      </ul>
                    </div>
                  </div>
                  <div className="product-box product-wrap">
                    <div className="img-wrapper">
                      <div className="front">
                        <a href="product-page(no-sidebar).html"><img src="/assets/images/marketplace/pro/45.jpg" className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                      </div>
                      <div className="back">
                    ...
                    <div className="product-detail">
                      ...
                      <h4>$500.00</h4>
                      <ul className="color-variant quantity-variant box-l">
                        <li className="bg-light">5</li>
                        <li className="bg-light">6</li>
                        <li className="bg-light">7</li>
                      </ul>
                    </div>
                  </div>
                  <div className="product-box product-wrap">
        ...
        <section className="section-b-space">
          <img src="/assets/images/marketplace/product-banner.jpg" alt="" className="bg-img blur-up lazyload" />
              ...
              <div className="row">
                <div className="col-lg-4 col-md-6">
                  <div className="theme-card card-border bg-light border-0">
                    ...
                    <Slider slidesPerRow={1} className="offer-slider slide-1">
                      <div>
                        <div className="media">
                          <a href="product-page(no-sidebar).html"><img alt="" className="img-fluid blur-up lazyload" src="/assets/images/marketplace/pro/5.jpg" /></a>
                        ...
                        <div className="media">
                          <a href="product-page(no-sidebar).html"><img alt="" className="img-fluid blur-up lazyload" src="/assets/images/marketplace/pro/35.jpg" /></a>
                          <div className="media-body align-self-center">
                            <div className="rating"><i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /></div>
                            <a href="product-page(no-sidebar).html">
                              <h6>Slim Fit Cotton Shirt</h6>
                      ...
                      <div>
                        <div className="media">
                          <a href="product-page(no-sidebar).html"><img alt="" className="img-fluid blur-up lazyload" src="/assets/images/marketplace/pro-sm/3.jpg" /></a>
                          <div className="media-body align-self-center">
                            <div className="rating"><i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /></div>
                            <a href="product-page(no-sidebar).html">
                              <h6>Slim Fit Cotton Shirt</h6>
                        ...
                        <div className="media">
                          <a href="product-page(no-sidebar).html"><img alt="" className="img-fluid blur-up lazyload" src="/assets/images/marketplace/pro-sm/4.jpg" /></a>
                          <div className="media-body align-self-center">
                            <div className="rating"><i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /></div>
                            <a href="product-page(no-sidebar).html">
                              <h6>Slim Fit Cotton Shirt</h6>
        ...
        <section className="ratio_square">
          <div className="container">
            <div className="row">
              <div className="col-12">
                <div className="title-basic">
                  <h2 className="title font-fraunces"><i className="ti-bolt" />Don't Miss These</h2>
                </div>
              </div>
              <div className="col-12">
                <Slider slidesToShow={6} className="slide-6-product product-m no-arrow">
                  <div className="product-box product-wrap">
                    <div className="img-wrapper">
                      <div className="front">
                        <a href="product-page(no-sidebar).html"><img src="/assets/images/marketplace/pro/19.jpg" className="img-fluid blur-up lazyload bg-img" alt="" /></a>
        ...
        <section className="section-b-space">
          <div className="container">
            <div className="row partition3 partition_3">
              <div className="col-lg-4 ratio_square">
                <div className="theme-card card-border bg-light border-0">
                  <h5 className="title-border">new product</h5>
                  <Slider slidesPerRow={1} className="offer-slider slide-1">
                    <div>
                      <div className="media">
                        <a href="product-page(no-sidebar).html"><img alt="" className="img-fluid blur-up lazyload" src="/assets/images/marketplace/pro/1.jpg" /></a>
                        <div className="media-body align-self-center">
                          <div className="rating"><i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /></div>
                          <a href="product-page(no-sidebar).html">
                            <h6>Slim Fit Cotton Shirt</h6>
                      ...
                      <div className="media">
                        <a href="product-page(no-sidebar).html"><img alt="" className="img-fluid blur-up lazyload" src="/assets/images/marketplace/pro/2.jpg" /></a>
                        <div className="media-body align-self-center">
                          <div className="rating"><i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /></div>
                          <a href="product-page(no-sidebar).html">
                            <h6>Slim Fit Cotton Shirt</h6>
                      ...
                      <div className="media">
                        <a href="product-page(no-sidebar).html"><img alt="" className="img-fluid blur-up lazyload" src="/assets/images/marketplace/pro/3.jpg" /></a>
                        <div className="media-body align-self-center">
                          <div className="rating"><i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /></div>
                          <a href="product-page(no-sidebar).html">
                            <h6>Slim Fit Cotton Shirt</h6>
                    ...
                    <div>
                      <div className="media">
                        <a href="product-page(no-sidebar).html"><img alt="" className="img-fluid blur-up lazyload" src="/assets/images/marketplace/pro/4.jpg" /></a>
                        <div className="media-body align-self-center">
                          <div className="rating"><i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /></div>
                          <a href="product-page(no-sidebar).html">
                            <h6>Slim Fit Cotton Shirt</h6>
                      ...
                      <div className="media">
                        <a href="product-page(no-sidebar).html"><img alt="" className="img-fluid blur-up lazyload" src="/assets/images/marketplace/pro/6.jpg" /></a>
                        <div className="media-body align-self-center">
                          <div className="rating"><i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /></div>
                          <a href="product-page(no-sidebar).html">
                            <h6>Slim Fit Cotton Shirt</h6>
                    ...
                    <a href="true">
                      <div className="collection-banner mb-4 p-right text-end">
                        ...
                        <div className="contain-banner banner-3">
                          <div>
                            <h4 className="text-theme">save 30%</h4>
                            <h2 className="font-cormorant text-dark">toy</h2>
                          </div>
                        </div>
                      </div>
                    </a>
                  ...
                  <div className="col-md-12">
                    <a href="true">
                      <div className="collection-banner p-right text-end">
                        ...
                        <div className="contain-banner banner-3">
                          <div>
                            <h4 className="text-theme">save 60%</h4>
                            <h2 className="font-cormorant text-dark">dumble</h2>
                          </div>
                        </div>
                      </div>
                    </a>
              ...
              <div className="col-lg-4 ratio_square">
                <div className="theme-card card-border bg-light border-0">
                  ...
                  <Slider slidesPerRow={1} className="offer-slider slide-1">
                    <div>
                      <div className="media">
                        <a href="product-page(no-sidebar).html"><img alt="" className="img-fluid blur-up lazyload" src="/assets/images/marketplace/pro/7.jpg" /></a>
                        <div className="media-body align-self-center">
                          <div className="rating"><i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /></div>
                          <a href="product-page(no-sidebar).html">
                            <h6>Slim Fit Cotton Shirt</h6>
                      ...
                      <div className="media">
                        <a href="product-page(no-sidebar).html"><img alt="" className="img-fluid blur-up lazyload" src="/assets/images/marketplace/pro/8.jpg" /></a>
                        <div className="media-body align-self-center">
                          <div className="rating"><i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /></div>
                          <a href="product-page(no-sidebar).html">
                            <h6>Slim Fit Cotton Shirt</h6>
                      ...
                      <div className="media">
                        <a href="product-page(no-sidebar).html"><img alt="" className="img-fluid blur-up lazyload" src="/assets/images/marketplace/pro/9.jpg" /></a>
                        <div className="media-body align-self-center">
                          <div className="rating"><i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /></div>
                          <a href="product-page(no-sidebar).html">
                            <h6>Slim Fit Cotton Shirt</h6>
                    ...
                    <div>
                      <div className="media">
                        <a href="product-page(no-sidebar).html"><img alt="" className="img-fluid blur-up lazyload" src="/assets/images/marketplace/pro/10.jpg" /></a>
                        <div className="media-body align-self-center">
                          <div className="rating"><i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /></div>
                          <a href="product-page(no-sidebar).html">
                            <h6>Slim Fit Cotton Shirt</h6>
                      ...
                      <div className="media">
                        <a href="product-page(no-sidebar).html"><img alt="" className="img-fluid blur-up lazyload" src="/assets/images/marketplace/pro/11.jpg" /></a>
                        <div className="media-body align-self-center">
                          <div className="rating"><i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /></div>
                          <a href="product-page(no-sidebar).html">
                            <h6>Slim Fit Cotton Shirt</h6>
                      ...
                      <div className="media">
                        <a href="product-page(no-sidebar).html"><img alt="" className="img-fluid blur-up lazyload" src="/assets/images/marketplace/pro/12.jpg" /></a>
                        <div className="media-body align-self-center">
                          <div className="rating"><i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /> <i className="fa fa-star" /></div>
                          <a href="product-page(no-sidebar).html">
                            <h6>Slim Fit Cotton Shirt</h6>
        ...
        {/*center product slider */}
        {/* product section start*/}
        <section className="pt-0 ratio_square">
          <div className="container">
            <div className="row section-b-space">
              <div className="col-lg-3 col-md-4 col-sm-5 col-6">
                <div className="h-100">
                  <img src="/assets/images/marketplace/banner/vertical3.jpg" className="img-fluid bg-img bg-top" alt="" />
                </div>
              </div>
              <div className="col-lg-9 col-md-8 col-sm-7 col-6">
                <Slider slidesToShow={5} className="marketplace-5 product-m no-arrow">
                  <div className="product-box product-wrap">
                    <div className="img-wrapper">
                      <div className="front">
                        <a href="product-page(no-sidebar).html"><img src="/assets/images/marketplace/pro/18.jpg" className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                      </div>
                      <div className="back">
                  ...
                  <div className="product-box product-wrap">
                    <div className="img-wrapper">
                      <div className="front">
                        <a href="product-page(no-sidebar).html"><img src="/assets/images/marketplace/pro/1.jpg" className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                      </div>
                      <div className="back">
                        <a href="product-page(no-sidebar).html"><img src="/assets/images/marketplace/pro/24.jpg" className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                      </div>
                  ...
                  <div className="product-box product-wrap">
                    <div className="img-wrapper">
                      <div className="front">
                        <a href="product-page(no-sidebar).html"><img src="/assets/images/marketplace/pro/35.jpg" className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                      </div>
                      <div className="back">
                        <a href="product-page(no-sidebar).html"><img src="/assets/images/marketplace/pro/31.jpg" className="img-fluid blur-up lazyload bg-img" alt="" /></a>
                      </div>
            ...
            <div className="row">
              <div className="col-12">
                <div className="title-basic">
                  <h2 className="title font-fraunces"><i className="ti-bolt" />Big Savings</h2>
                </div>
              </div>
              <div className="col-12">
                <Slider slidesToShow={6} className="slide-6-product product-m no-arrow">
