    ...
    <>
      <div>
              ...
              <div className="col-12">
                <div className="title-basic">
                  <h2 className="title font-fraunces">
                    <i className="ti-bolt" /> deals of the day
                  </h2>
                  <div className="timer">
                    <p id="demo" />
                  </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-3 col-md-4 col-sm-6 col-6">
                <div className="h-100">
                  <img
                    src="/assets/images/marketplace/banner/vertical2.jpg"
        ...
        <section className="section-b-space">
          <img
            src="/assets/images/marketplace/product-banner.jpg"
            alt=""
                    ...
                    <a href="true">
                      <div className="collection-banner mb-4 p-right text-end">
                        <div className="img-part">
                          <img
                            src="/assets/images/marketplace/banner/21.jpg"
                            alt=""
                  ...
                  <div className="col-md-12">
                    <a href="true">
                      <div className="collection-banner p-right text-end">
                        <div className="img-part">
                          <img
                            src="/assets/images/marketplace/banner/22.jpg"
                            alt=""
                            className="img-fluid blur-up lazyload bg-img"
                          />
                        </div>
          ...
          <div className="container">
            <div className="row section-b-space">
              <div className="col-lg-3 col-md-4 col-sm-5 col-6">
                <div className="h-100">
                  <img
                    src="/assets/images/marketplace/banner/vertical3.jpg"
                    className="img-fluid bg-img bg-top"
                    alt=""
                  />
                </div>
