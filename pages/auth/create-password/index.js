              ...
              <Form className="theme-form" style={{ marginTop: "10px" }} onSubmit={handleCreatePass}>
                <div className="form-row row">
                  <div className="col-md-12 d-flex">
                    ...
                    <div onClick={handleShowPassword} style={{ display: showPass }} className={styles.hideShowPassword2}>
                      <AiFillEye className={styles.iconPassword} />
                    </div>
                    <div onClick={handlHidePassword} style={{ display: hidePass }} className={styles.hideShowPassword2}>
